            ...
            <div className="p-5 md:p-10">
                ...
                <ul className="list-disc px-5 md:px-10">
                    <li className="my-2">
                        ...
                        your email address and name. This information is used to
                        show on your profile page.
                    </li>
                    <li className="my-2">
                        When you upload a material on our website, we collect
                        your email address. This information is used for
                ...
                <p className="my-2">
                    When you upload a material for request, we collect the
                    content of the material, along with any additional
                    information you provide. This information is used for
                    approving, rejecting, and publishing purposes.
                </p>
                ...
                <hr className="opacity-70 mb-3" />
                <h3 className="text-xl font-bold my-2">
                    2.1 Review and Approvation:
                </h3>
                <p className="my-2">
                    We collect and use your personal information to review the
                    material submitted by you and determine whether they meet
                    our guidelines for publication. If approved, your material
                    will be published globally on our website.
                </p>

                <h3 className="text-xl font-bold my-2">2.2 Communication:</h3>
                <p className="my-2">
                    We may use your name and email address to communicate with
                    you regarding your material submissions, updates, and
                    notifications related to our services.
                </p>

                <h3 className="text-xl font-bold my-2">2.3 Aggregate Data:</h3>
                <p className="my-2">
                    We may anonymize and aggregate the data collected from users
                    to analyze trends, improve our services, and generate
                    statistical information. This aggregated data will not
                ...
                <p className="my-2">
                    Your submitted materials and associated personal information
                    will be accessible to our authorized administrators and
                    reviewers who are involved in the material review process.
                </p>
                ...
                <p className="my-2">
                    ...
                    law, regulation, or legal process, or to protect our rights,
                ...
                <p className="my-2">
                    ...
                    information submitted to us against unauthorized access,
                    loss, alteration, or destruction. However, no method of
                ...
                <p className="my-2">
                    You do not have the right to access and update your personal
                    information provided to us. Once you submit a material, your
                    id will be stored.
                </p>
                ...
                <p className="my-2">
                    ...
                    for the privacy practices or the content of such third-party
                    websites. We encourage you to review the privacy policies of
                    those third parties before providing any personal
                    information.
                </p>
