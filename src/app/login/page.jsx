  ...
  return (
    <div className="fixed left-0 top-0 -z-10 h-full w-full">
      <div className="relative flex flex-col items-center justify-center h-full text-center content-center">
        ...
        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">A living open-source repository of academic resources for DA-IICT</p>
