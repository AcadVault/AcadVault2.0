        ...
        <div className="fixed left-0 top-0 -z-10 h-full w-full px-2">
            ...
            <div className="flex flex-col items-center justify-center h-full text-center content-center">
                ...
                <div className="flex flex-row">
                    ...
                    <button onClick={() => signIn("google", { callbackUrl: "/" })} className="inline-flex items-center justify-center text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 font-medium rounded-lg text-base px-5 py-2.5 me-2"><FcGoogle className="w-4 h-4 me-2" /> Login with Google</button>
                </div>
