...
const AboutPage = () => {
    ...
    return (
        <div className="left-0 top-0 h-full -z-10 w-full">
            ...
            <h1 className="text-3xl font-bold text-white text-center mt-10">What is AcadVault2.0?</h1>
            <p className="text-lg text-white text-center mt-5 w-11/12 sm:w-4/5 md:w-3/4 lg:w-2/3 gap-4 p-1 md:p-5 mx-auto">The project is based on the vanilla{" "}<a href="https://github.com/Tikam02/AcadVault" className="text-blue-500">Acadvault</a>{" "}GitHub repository of our alumni{" "}<a href="https://github.com/Tikam02" className="text-blue-500">Tikam Singh Alma</a>. We aim to maintain a network for an{" "}<b className="whitespace-nowrap">Academic Material Sharing Platform</b>.</p>
            <h1 className="text-3xl font-bold text-white text-center mt-10">Resource Managers</h1>
            ...
            <h1 className="text-3xl font-bold text-white text-center mt-10">GitHub Contributors</h1>
