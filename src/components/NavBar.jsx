...
const NavBar = ({ isResourceManager, session }) => {
    ...
    return (
        <nav className="bg-white bg-opacity-[0.02] backdrop backdrop-blur-sm">
            <div
                className={`${
            ...
            >
                ...
                <div className={'flex flex-col rtl:space-x-reverse'}>
                    ...
                    <div
                        className={`${
                            isMenuOpen
                                ? 'flex absolute right-5 top-16 py-3 z-50 bg-white bg-opacity-[0.02] backdrop backdrop-blur-sm border border-gray-500 rounded-md  min-w-[200px] items-center text-white'
                                : 'hidden'
                        ...
                        {session ? (
                            <>
                                <a
                                    href="/browse"
                                    style={{
                                        color: pathname.includes('/browse')
                                            ? `${activeColor}`
                                            : '',
                                        fontWeight: pathname.includes('/browse')
                                            ? 'bold'
                                            : '',
                                    }}
