    ...
    <div className="mb-6 pt-4">
      ...
      <div className="mb-8">
        ...
        >
          <div>
            {file ? (
              <span className="mb-4 block text-base font-normal text-[#07074D]">
                {file.name}
              </span>
            ) : (
              <>
            ...
            <span className="inline-flex rounded border cursor-pointer border-[#b9b9b9] py-2 px-7 text-base font-medium text-[#07074D]">
