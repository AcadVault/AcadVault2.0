  ...
  return (
    <div className="mb-6 pt-4">
      ...
      <div className="mb-8">
        ...
        >
          <div>
            {file ? (<span className="mb-4 block text-base font-normal ">{file.name}</span>) : (<><span className="mb-2 block text-xl font-semibold ">Drop file here</span><span className="mb-2 block text-base font-medium text-[#6B7280]">Or</span></>)}
